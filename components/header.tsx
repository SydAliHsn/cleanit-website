      ...
      <div className="container">
        ...
        >
          ...
          <Image
            ...
            src="/images/medico-logo-dark.png"
            decoding="async"
            loading="lazy"
            alt="CleanIt"
            width="221"
        ...
        >
          <ul>
            ...
            <li>
              <Link
                href={'/contact'}
                style={{ padding: '1rem 1.1rem', fontSize: '0.9em', height: 'auto', lineHeight: '1' }}
        ...
        {/* <!--Mobile Nav toggle--> */}
        <button
          className={`hamburger-menu ${navState ? 'clicked' : ''}`}
